                   ...
                   <c:forEach items="${all}" var="data" varStatus="l">
                    ...
                    <!--之一 details -->
                     ...
                     <c:forEach items="${data.details}" var="chil" varStatus="l">
	                      <div style="display: flex;align-items: center;width:838px;border-bottom:1px dashed #ddd;padding:30px 50px;" class="hidden_yh center_yh">
	                        ...
	                        <div class="right_yh">
	                         <c:if test="${data.status == 3}"> 
	                            <a href="${ctx}/itemOrder/pj?id=${chil.itemId}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top:10px;padding:6px;border: 1px solid #666">去评价</a>
	                        </c:if>
	                        </div>
	                     </div>
                     </c:forEach>
                    <!--总结-->
                    <div style="width:838px;padding:30px 50px;" class="hidden_yh center_yh tleft">

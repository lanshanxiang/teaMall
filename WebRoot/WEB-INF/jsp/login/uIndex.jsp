		...
		<div class="footer">
			...
			<div class="footerbox clearfix">
				<div class="left_footer">
					<div class="img">
						<img src="${ctx}/resource/users/images/img_33.png" />
					</div>
					<div class="phone">
						<h2>服务咨询电话</h2>
				...
				<div class="right_footer">
					<dl>
						<dt>
							<em class="${ctx}/resource/users/icon_img"></em>购物指南
						</dt>
						<dd>
							<a href="#">怎样购物</a>
						</dd>
					...
					<dl>
						<dt>
							<em class="${ctx}/resource/users/icon_img"></em>配送方式
						</dt>
						<dd>
							<a href="#">快递资费及送达时间</a>
						</dd>
					...
					<dl>
						<dt>
							<em class="${ctx}/resource/users/icon_img"></em>售后服务
						</dt>
						<dd>
							<a href="#">退换货原则</a>
						</dd>
					...
					<dl>
						<dt>
							<em class="${ctx}/resource/users/icon_img"></em>关于我们
						</dt>
						<dd>
							<a href="#">关于我们</a>
						</dd>
			...
			<div class="slogen">
				<div class="footerbox clearfix ">
					<ul class="wrap">
						<li><a href="#"><img src="${ctx}/resource/users/images/icon_img_02.png"
								data-bd-imgshare-binded="1"></a> <b>正品保证</b> <span>正品行货
								放心选购</span></li>
						<li><a href="#"><img src="${ctx}/resource/users/images/icon_img_03.png"
								data-bd-imgshare-binded="2"></a> <b>满68元包邮</b> <span>购物满68元，免费快递</span>
						</li>
						<li><a href="#"><img src="${ctx}/resource/users/images/icon_img_04.png"
								data-bd-imgshare-binded="3"></a> <b>厂家直供</b> <span>价格更低，质量更可靠</span>
						</li>
						<li><a href="#"><img src="${ctx}/resource/users/images/icon_img_05.png"

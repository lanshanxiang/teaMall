...
<body>
	<div class="width100">
		<div class="width1200 center_yh hidden_yh" style="height: 181px">
			<a href="#" class="left_yh"><img
				src="${ctx}/resource/images/looo.png"
				style="height: 80px; padding-top: 30px"></a> <a
				href="${ctx}/login/res" class="right_yh font16 c_33"
				style="line-height: 181px;">还没有账号，<font class="red">马上去注册></font></a>
		</div>
	</div>
		...
		<div class="width1200 center_yh hidden_yh" style="margin-top: 70px">
			<div class="right_yh bj_fff" style="width: 408px; height: 438px;">
				<h3 class="tcenter font30 c_33"
					style="font-weight: 100; margin-top: 36px; margin-bottom: 36px;">账户登录</h3>
					...
					<form action="${ctx}/login/utoLogin" method="post">
						<div class="width100 box-sizing hidden_yh"
							...
							<img src="${ctx}/resource/user/images/rw.jpg" class="left_yh"
								...
								placeholder="请输入用户名或手机号" name="userName" value="zs"
